...
/*  
// ADDITIONAL SECTION OF API ADDED HERE
...
async function getISSnow() {
  ...
  document.getElementById('timest').textContent = timestamp;
}
...
// SHARPNESS AND SPEED OF ORBS
app.stage.filters = [new KawaseBlurFilter(20, 7, true)];
